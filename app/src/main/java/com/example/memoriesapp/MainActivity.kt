...
import com.example.memoriesapp.Fragments.HomeFragment
import com.example.memoriesapp.Fragments.NotificationsFragment
    ...
    private val onNavigationItemSelectedListener = BottomNavigationView.OnNavigationItemSelectedListener { item ->
        when (item.itemId) {
            ...
            R.id.nav_add_post -> {
                ...
                startActivity(Intent(this@MainActivity, CreateMemoryActivity::class.java))
                return@OnNavigationItemSelectedListener true
            }
